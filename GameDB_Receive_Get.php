...
//◆◆◆◆◆◆◆◆◆◆◆◆◆◆◆◆◆◆◆◆◆◆◆◆◆◆◆
//アクセスアドレス
//http://jyarashi.php.xdomain.jp/GAME_DB/GameDB_Receive_Get.php?game_tytle=TestGame&user_id=TestPlayer&message1=message1&message2=message2
//
//USER:jyarashi_game
//PASSWORD:game4game4
//
...
//--------------------------------------------------
	//引数設定
	if(isset($_GET['game_tytle']))
	{
		$game_tytle = $_GET['game_tytle'];
	}
